 ...
 */
@ApiModel(description = "Entity MaritalStatus")
@Entity
@Table(name = "hcm_m_marital_status")
...
public class MaritalStatus implements Serializable {
    ...
    public MaritalStatus description(String description) {
    ...
    public MaritalStatus activeFlag(Boolean activeFlag) {
    ...
    public MaritalStatus tenantId(Long tenantId) {
    ...
    public MaritalStatus companyCode(Long companyCode) {
