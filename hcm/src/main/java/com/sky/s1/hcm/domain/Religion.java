...
public class Religion implements Serializable {
    ...
    public Religion code(String code) {
        this.code = code;
        return this;
    }
    ...
    public Religion activeFlag(Boolean activeFlag) {
    ...
    public Religion tenantId(Long tenantId) {
    ...
    public Religion companyCode(Long companyCode) {
