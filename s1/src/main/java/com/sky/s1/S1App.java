...
import com.sky.s1.config.ApplicationProperties;
import com.sky.s1.config.DefaultProfileUtil;
...
public class S1App {
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(S1App.class);
